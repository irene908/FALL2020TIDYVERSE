...
```
# Part 1: Tidyverse Create : Zachary Palmore
## Objective 
...
```
# Part 2: Tidyverse EXTEND : Irene Jacob
...
After you’ve extended your classmate's vignette, please submit your GitHub handle name in the submission link provided below.  This will let your instructor know that your work is ready to be graded.

## Description

read_tsv() is a function designed specifically for reading files of tab separated values.
...
```{r eval=FALSE, results='asis'}
read_tsv("C:/Users/irene/Documents/GitHub/FALL2020TIDYVERSE-1/potatoes.txt")
```
...
```{r, echo=TRUE, results='asis', eval=FALSE}
read_tsv("http://s3.amazonaws.com/assets.datacamp.com/production/course_1477/datasets/potatoes.txt")
```
